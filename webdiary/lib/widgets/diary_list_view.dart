...
import 'package:webdiary/util/utils.dart';
import 'package:webdiary/widgets/delete_entry_dialog.dart';
import 'package:webdiary/widgets/inner_list_card.dart';
import 'package:webdiary/widgets/write_diary_dialog.dart';
                            ...
                            SizedBox(
                              ...
                              child: Center(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Guarda tu memoria el ${formatDate(selectedDate)}',
                                      style:
                                    ...
                                    TextButton.icon(
                                      ...
                                      label: Text(
                                          'Da click aquí para agregar una entrada'),
                                      onPressed: () {
                                        showDialog(
                                          context: context,
                                          builder: (context) {
